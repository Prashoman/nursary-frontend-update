...
export const Product = () => {
  ...
  const { data: category, isLoading:categoryLoading } = useGetCategoryQuery(undefined);
  ...
  const handleProductEdit = (item:string)=>{
    setUpdateProductInf(item);
                  ...
                  <tbody>
                    {products.data?.map((item: unknown, index: number) => (
                      <tr key={index}>
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                          <p className="text-gray-900 whitespace-no-wrap">
                            <img src={item?.image} className="w-[100px] h-[100px]" alt="image"  />
                          </p>
                        </td>
                        <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                          <p className="text-gray-900 whitespace-no-wrap">

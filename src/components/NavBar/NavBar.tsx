...
export default function NavBar() {
  ...
  const cartProduct = useSelector((state: RootState) => state.cart) as unknown;
  console.log("Navbar :", cartProduct);
      ...
      <div>
        ...
        <AnimatePresence>
          {isCartOpen && (
            ...
            >
              {
                cartProduct?.cart?.map((product:TProducts)=>(
                  <div className="flex items-center gap-3 border-b border-yellow-200 py-2">
                ...
                <div className="w-[85%] flex items-center justify-between">
                  ...
                  <div className="w-[40%] flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <input type="text" value={1} className="w-7 px-1" />
                      <span>
                        <HiMinus
                          // onClick={() => {
